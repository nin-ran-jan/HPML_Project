...
data = [
    dict(cfg="8-bit draft", tp=12.818, lat=78.018, speed=0.834, acc=0.602),
    dict(cfg="4-bit draft", tp=14.423, lat=69.335, speed=0.938, acc=0.539),
    dict(cfg="8-bit target", tp=14.661, lat=68.207, speed=0.954, acc=0.601),
    dict(cfg="8-bit tgt + 4-bit drft", tp=11.025, lat=90.702, speed=0.717, acc=0.537),  
]
