...
data = [
    dict(sampling=False, k=3, tp=17.099, lat=58.481, speed=1.112, acc=0.673),
    dict(sampling=False, k=5, tp=16.580, lat=60.313, speed=1.079, acc=0.610),
    dict(sampling=False, k=7, tp=15.928, lat=62.782, speed=1.036, acc=0.559),
    dict(sampling=True , k=3, tp=16.794, lat=59.546, speed=1.093, acc=0.660),
    dict(sampling=True , k=5, tp=16.324, lat=61.261, speed=1.062, acc=0.605),
    dict(sampling=True , k=7, tp=15.475, lat=64.621, speed=1.010, acc=0.556),
]
